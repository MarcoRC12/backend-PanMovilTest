...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://panaderia.informaticapp.com/registros',
...
<div class="container-fluid">
	<div class="row">
		<h1 class="col-xl-12 text-center">API Modelo de Negocio Bread and Fred</h1>
		...
		<div class="row col-xl-12 my-6">
        		...
        		<div class="row col-xl-8 offset-2 bg-success text-white font-weight-bold py-2">
					<?php print_r(
						"Cliente id: ".$datos['credenciales']['cliente_id']); ?>
				</div>
        		<div class="row col-xl-8 offset-2 bg-info text-white font-weight-bold py-2">
				<?php print_r(
						"Llave secreta: ".$datos['credenciales']['llave_secreta']); ?>
				</div>
        </div>
    	<?php endif ?>
